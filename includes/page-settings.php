<div class="wrap">
    <h2><?php _e( 'NYU Stream Embed', $this->text_domain ) ?></h2>
    ...
    <?php
        ...
        if ( 'network' == $network ): ?>
            <div id="nse-network-settings">
                ...
                <h3 class="title nse-video-settings"><?php _e( 'NYU Stream Embed Settings for Video', $this->text_domain ) ?></h3>
                ...
                <form method="post" action="">
                    <table  class="form-table nse-video-settings">
                        ...
                        <tr class="nse-video-settings" valign="top">
                            ...
                            <td>
                                <input type="text" name="nse_settings_video_id" class="regular-text" <?php if ( !empty( $this->current_settings['nse_settings']['nse_settings_video_id'] ) ) { echo "value=".$this->current_settings['nse_settings']['nse_settings_video_id']; } ?> />
